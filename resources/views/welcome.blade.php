    ...
    <div class="container">
      <div class="row m-t-xl m-b-xl">
        ...
        <div class="col-sm-6 text-center">
          <a href="http://themeforest.net/item/angulr-bootstrap-admin-web-app-with-angularjs/8437259" class="btn btn-lg btn-default btn-rounded">Get Angulr Now</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row m-t-xl m-b-xl">
        ...
        <div class="col-sm-3">
          ...
          <p class="text-sm">23 soe Midlokls <br>
           ...
           <p>Sale: <a href="mailto:hey@example.com">infoexample.com</a></p>
           <p class="m-b-xl">Job: <a href="mailto:hey@example.com">jobexample.com</a></p>
        </div>
        <div class="col-sm-3">
...
<script src="{{ asset('/bower_components/jquery_appear/jquery.appear.js') }}"></script>
