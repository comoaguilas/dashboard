				...
				<ul class="list-group list-group-lg m-b-none">
					<li class="list-group-item">
						<a href class="thumb-sm m-r">
							<img src="{{ url('/img/a1.jpg') }}" class="r r-2x">
						</a>
					...
					<li class="list-group-item">
						<a href class="thumb-sm m-r">
							<img src="{{ url('/img/a2.jpg') }}" class="r r-2x">
						</a>
					...
					<li class="list-group-item">
						<a href class="thumb-sm m-r">
							<img src="{{ url('/img/a3.jpg') }}" class="r r-2x">
						</a>
					...
					<li class="list-group-item">
						<a href class="thumb-sm m-r">
							<img src="{{ url('/img/a4.jpg') }}" class="r r-2x">
						</a>
						<span class="pull-right label bg-warning inline m-t-sm">Editor</span>
